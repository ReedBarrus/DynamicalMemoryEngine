// scripts/run_door_one_continuous_replay_capstone.js
//
...
//
// Lens posture:
//   base_window_N=512, hop_N=256, Fs_target=2400 Hz
...
//
// Run:
//   node scripts/run_door_one_continuous_replay_capstone.js
//
// Optional env overrides:
//   DOOR_ONE_CAPSTONE_AUDIO_DIR   — override ./test_signal/daw_tone_continuity/
//   DOOR_ONE_CAPSTONE_OUTPUT_DIR  — override ./out_experiments/continuous_replay_capstone
//   DOOR_ONE_CAPSTONE_PROVENANCE  — override ./out_provenance/continuous_replay_capstone
...
const AUDIO_DIR = process.env.DOOR_ONE_CAPSTONE_AUDIO_DIR
    ?? path.resolve(__dirname, "../test_signal/daw_tone_continuity");
const OUTPUT_DIR = process.env.DOOR_ONE_CAPSTONE_OUTPUT_DIR
    ?? "./out_experiments/continuous_replay_capstone_lens512";
const PROV_ROOT = process.env.DOOR_ONE_CAPSTONE_PROVENANCE
    ?? "./out_provenance/continuous_replay_capstone_lens512";
const PIN_ROOT = process.env.DOOR_ONE_CAPSTONE_PIN_ROOT
    ?? "./out_provenance/continuity_lens512";
...
const BASE_POLICIES = {
    clock_policy_id: "clock.capstone.continuity_lens512.v1",

    ingest_policy: {
        policy_id: "ingest.capstone.continuity.v1",
    ...
    // base_window_N=512 at 2400 Hz → ~0.214 s window duration.
    ...
    transform_policy: {
        policy_id: "transform.capstone.continuity.v1",
        transform_type: "fft",
    ...
    compression_policy: {
        policy_id: "compress.capstone.continuity.v1",
    ...
    anomaly_policy: {
        policy_id: "anomaly.capstone.continuity.v1",
    ...
    merge_policy: {
        policy_id: "merge.capstone.continuity.v1",
    ...
    post_merge_compression_policy: {
        policy_id: "merge.compress.capstone.continuity.v1",
        selection_method: "topK",
        budget_K: 16,
        maxK: 16,
        include_dc: true,
    ...
    reconstruct_policy: {
        policy_id: "reconstruct.capstone.continuity.v1",
    ...
    basin_policy: {
        policy_id: "basin.capstone.continuity.v1",
    ...
    consensus_policy: {
        policy_id: "consensus.capstone.continuity.v1",
...
const QUERY_SPEC = {
    query_id: "q.capstone.continuity",
    kind: "energy_trend",
    mode: "ENERGY",
...
const QUERY_POLICY = {
    policy_id: "qp.capstone.continuity.v1",
...
const EPOCH_CONTEXT = {
    epoch_id: "epoch.capstone.continuity.v1",
    t_start: 0,
    t_end: 60,
    settlement_policy_id: "settlement.capstone.continuity.v1",
    consensus_window: 10,
};
...
const SOURCE_ID = "door1.audio.daw_tone.continuity_v1";
...
async function main() {
    ...
    console.log("Door One Continuous Replay Capstone");
    console.log(`  source dir : ${AUDIO_DIR}`);
    console.log(`  output dir : ${OUTPUT_DIR}`);
    console.log(`  prov root  : ${PROV_ROOT}`);
    console.log(`  lens       : base_window_N=512, hop_N=256, Fs_target=${TARGET_SAMPLE_RATE} Hz`);
    ...
    const lane = new DoorOneExecutiveLane({
        ...
        session_id: "door-one-continuous-replay-capstone",
    });
    ...
    // ── Experiment manifest ────────────────────────────────────────────────────
    const manifest = {
        experiment_type: "door_one_continuity_replay_capstone_lens512",
        ...
        generated_from: "door_one_continuous_replay_capstone runner — not canon, not promotion",
    };
...
function buildProvenanceReceipt({ cycleIndex, runLabel, phase, runDir, result, rawInput, filePath }) {
    ...
    return {
        ...
        generated_from:
            "Door One continuous replay capstone — durable provenance receipt, not canon, not promotion",
...
async function buildAndWritePinPacket({ provenanceRoot, pinRoot, digest, manifest }) {
    ...
    const packet = {
        ...
        packet_metadata: {
            declared_purpose: "continuous_replay_capstone_cohort",
            pin_label: `daw_tone_continuity_lens512_v1_cycles_${String(cycleMin ?? 0).padStart(4, "0")}_${String(cycleMax ?? 0).padStart(4, "0")}`,
