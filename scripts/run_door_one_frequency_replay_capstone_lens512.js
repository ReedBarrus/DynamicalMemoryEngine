// scripts/run_door_one_frequency_replay_capstone.js
//
// Door One frequency replay capstone — DAW tone / frequency perturbation axis
//
// Purpose:
...
//
// Experiment shape:
//   Phase A — baseline_stable    (3 runs): clean continuous DAW tone (300hz)
//   Phase B — frequency_shift   (3 runs): same sine wave, but outputting at around 440hz, instead of 300hz
...
//   frequency_shift_01/02/03 are intentionally condition-identical within phase.
...
//
// Run:
//   node scripts/run_door_one_frequency_replay_capstone.js
//
// Optional env overrides:
//   DOOR_ONE_CAPSTONE_AUDIO_DIR   — override ./test_signal/daw_tone_frequency/
//   DOOR_ONE_CAPSTONE_OUTPUT_DIR  — override ./out_experiments/frequency_replay_capstone_lens512
//   DOOR_ONE_CAPSTONE_PROVENANCE  — override ./out_provenance/frequency_replay_capstone_lens512
...
const AUDIO_DIR = process.env.DOOR_ONE_CAPSTONE_AUDIO_DIR
    ?? path.resolve(__dirname, "../test_signal/daw_tone_frequency");
const OUTPUT_DIR = process.env.DOOR_ONE_CAPSTONE_OUTPUT_DIR
    ?? "./out_experiments/frequency_replay_capstone_lens512";
const PROV_ROOT = process.env.DOOR_ONE_CAPSTONE_PROVENANCE
    ?? "./out_provenance/frequency_replay_capstone_lens512";
const PIN_ROOT = process.env.DOOR_ONE_CAPSTONE_PIN_ROOT
    ?? "./out_provenance/daw_tone_frequency_lens512_v1";
...
const BASE_POLICIES = {
    clock_policy_id: "clock.capstone.frequency_lens512.v1",

    ingest_policy: {
        policy_id: "ingest.capstone.frequency.v1",
    ...
    transform_policy: {
        policy_id: "transform.capstone.frequency.v1",
        transform_type: "fft",
    ...
    compression_policy: {
        policy_id: "compress.capstone.frequency.v1",
    ...
    anomaly_policy: {
        policy_id: "anomaly.capstone.frequency.v1",
    ...
    merge_policy: {
        policy_id: "merge.capstone.frequency.v1",
    ...
    post_merge_compression_policy: {
        policy_id: "merge.compress.capstone.frequency.v1",
        selection_method: "topK",
        budget_K: 16,
        maxK: 16,
        include_dc: true,
    ...
    reconstruct_policy: {
        policy_id: "reconstruct.capstone.frequency.v1",
    ...
    basin_policy: {
        policy_id: "basin.capstone.frequency.v1",
    ...
    consensus_policy: {
        policy_id: "consensus.capstone.frequency.v1",
...
const QUERY_POLICY = {
    policy_id: "qp.capstone.frequency.v1",
...
const EPOCH_CONTEXT = {
    epoch_id: "epoch.capstone.frequency.v1",
    t_start: 0,
    t_end: 60,
    settlement_policy_id: "settlement.capstone.frequency.v1",
    consensus_window: 10,
};
...
const SOURCE_ID = "door1.audio.daw_tone.frequency_v1";
...
const RUN_PLAN = [
    ...
    { run_label: "frequency_shift_01", phase: "phase_perturbation", filename: "frequency_shift_01.wav" },
    { run_label: "frequency_shift_02", phase: "phase_perturbation", filename: "frequency_shift_02.wav" },
    { run_label: "frequency_shift_03", phase: "phase_perturbation", filename: "frequency_shift_03.wav" },
    // Phase C — return
...
async function main() {
    ...
    console.log("Door One Frequency Replay Capstone");
    ...
    const lane = new DoorOneExecutiveLane({
        ...
        session_id: "door-one-frequency-replay-capstone",
    });
    ...
    const manifest = {
        ...
        generated_from: "door_one_frequency_replay_capstone_lens512 runner — not canon, not promotion",
    };
...
function buildProvenanceReceipt({ cycleIndex, runLabel, phase, runDir, result, rawInput, filePath }) {
    ...
    return {
        ...
        generated_from:
            "Door One frequency replay capstone — durable provenance receipt, not canon, not promotion",
...
async function buildAndWritePinPacket({ provenanceRoot, pinRoot, digest, manifest }) {
    ...
    const packet = {
        ...
        packet_metadata: {
            declared_purpose: "frequency_replay_capstone_lens512_cohort",
            pin_label: `daw_tone_frequency_v1_cycles_${String(cycleMin ?? 0).padStart(4, "0")}_${String(cycleMax ?? 0).padStart(4, "0")}`,
