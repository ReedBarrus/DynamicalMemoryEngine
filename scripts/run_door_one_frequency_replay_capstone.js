...
//   DOOR_ONE_CAPSTONE_OUTPUT_DIR  — override ./out_experiments/frequency_replay_capstone
//   DOOR_ONE_CAPSTONE_PROVENANCE  — override ./out_provenance/frequency_replay_capstone
...
const OUTPUT_DIR = process.env.DOOR_ONE_CAPSTONE_OUTPUT_DIR
    ?? "./out_experiments/frequency_replay_capstone";
const PROV_ROOT = process.env.DOOR_ONE_CAPSTONE_PROVENANCE
    ?? "./out_provenance/frequency_replay_capstone";
const PIN_ROOT = process.env.DOOR_ONE_CAPSTONE_PIN_ROOT
    ?? "./out_provenance/daw_tone_frequency_v1";
...
const BASE_POLICIES = {
    clock_policy_id: "clock.capstone.frequency.v1",
...
async function main() {
    ...
    const manifest = {
        ...
        generated_from: "door_one_frequency_replay_capstone runner — not canon, not promotion",
    };
...
async function buildAndWritePinPacket({ provenanceRoot, pinRoot, digest, manifest }) {
    ...
    const packet = {
        ...
        packet_metadata: {
            declared_purpose: "frequency_replay_capstone_cohort",
