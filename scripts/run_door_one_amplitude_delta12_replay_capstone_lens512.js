...
//
// Experiment shape:
//   Phase A — baseline_stable    (3 runs): clean continuous DAW tone (300 hz sine wave at -6db output)
//   Phase B — amplitude_shift   (3 runs): same tone with -12 db amplitude from baseline
...
//   DOOR_ONE_CAPSTONE_AUDIO_DIR   — override ./test_signal/daw_tone_amplitude_delta12/
//   DOOR_ONE_CAPSTONE_OUTPUT_DIR  — override ./out_experiments/amplitude_delta12_replay_capstone
//   DOOR_ONE_CAPSTONE_PROVENANCE  — override ./out_provenance/amplitude_delta12_replay_capstone
...
const AUDIO_DIR = process.env.DOOR_ONE_CAPSTONE_AUDIO_DIR
    ?? path.resolve(__dirname, "../test_signal/daw_tone_amplitude_delta12");
const OUTPUT_DIR = process.env.DOOR_ONE_CAPSTONE_OUTPUT_DIR
    ?? "./out_experiments/amplitude_delta12_replay_capstone_lens512";
const PROV_ROOT = process.env.DOOR_ONE_CAPSTONE_PROVENANCE
    ?? "./out_provenance/amplitude_delta12_replay_capstone_lens512";
const PIN_ROOT = process.env.DOOR_ONE_CAPSTONE_PIN_ROOT
    ?? "./out_provenance/daw_tone_amplitude_delta12_lens512_v1";
...
const BASE_POLICIES = {
    clock_policy_id: "clock.capstone.amplitude_delta12_lens512.v1",

    ingest_policy: {
        policy_id: "ingest.capstone.amplitude_delta12.v1",
    ...
    transform_policy: {
        policy_id: "transform.capstone.amplitude_delta12.v1",
        transform_type: "fft",
    ...
    compression_policy: {
        policy_id: "compress.capstone.amplitude_delta12.v1",
    ...
    anomaly_policy: {
        policy_id: "anomaly.capstone.amplitude_delta12.v1",
    ...
    merge_policy: {
        policy_id: "merge.capstone.amplitude_delta12.v1",
    ...
    post_merge_compression_policy: {
        policy_id: "merge.compress.capstone.amplitude_delta12.v1",
        selection_method: "topK",
        budget_K: 16,
        maxK: 16,
        include_dc: true,
    ...
    reconstruct_policy: {
        policy_id: "reconstruct.capstone.amplitude_delta12.v1",
    ...
    basin_policy: {
        policy_id: "basin.capstone.amplitude_delta12.v1",
    ...
    consensus_policy: {
        policy_id: "consensus.capstone.amplitude_delta12.v1",
...
const QUERY_SPEC = {
    query_id: "q.capstone.amplitude_delta12",
    kind: "energy_trend",
    mode: "ENERGY",
...
const QUERY_POLICY = {
    policy_id: "qp.capstone.amplitude_delta12.v1",
...
const EPOCH_CONTEXT = {
    epoch_id: "epoch.capstone.amplitude_delta12.v1",
    t_start: 0,
    t_end: 60,
    settlement_policy_id: "settlement.capstone.amplitude_delta12.v1",
    consensus_window: 10,
};
...
const SOURCE_ID = "door1.audio.daw_tone.amplitude_delta12_v1";
...
async function main() {
    ...
    console.log("Door One Amplitude Delta12 Replay Capstone");
    ...
    const lane = new DoorOneExecutiveLane({
        ...
        session_id: "door-one-amplitude-delta12-replay-capstone",
    });
    ...
    // ── Experiment manifest ────────────────────────────────────────────────────
    const manifest = {
        experiment_type: "door_one_amplitude_delta12_lens512_replay_capstone",
        ...
        generated_from: "door_one_amplitude_delta12_lens512_replay_capstone runner — not canon, not promotion",
    };
...
function buildProvenanceReceipt({ cycleIndex, runLabel, phase, runDir, result, rawInput, filePath }) {
    ...
    return {
        ...
        generated_from:
            "Door One amplitude delta12 replay capstone — durable provenance receipt, not canon, not promotion",
...
async function buildAndWritePinPacket({ provenanceRoot, pinRoot, digest, manifest }) {
    ...
    const packet = {
        ...
        packet_metadata: {
            declared_purpose: "amplitude_delta12_replay_capstone_cohort",
            pin_label: `daw_tone_amplitude_delta12_lens512_v1_cycles_${String(cycleMin ?? 0).padStart(4, "0")}_${String(cycleMax ?? 0).padStart(4, "0")}`,
