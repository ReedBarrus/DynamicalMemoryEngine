// scripts/run_door_one_continuity_replay_capstone.js
//
// Door One continuous replay capstone — DAW tone / continuity perturbation axis
//
// Purpose:
//   - read 9 separate WAV files from ./test_signal/daw_tone_continuity/
...
//
// Experiment shape:
//   Phase A — baseline_stable    (3 runs): clean continuous DAW tone with embedded white noise: -9db sine wave output (300hz), -18 db white noise output
//   Phase B — continuity_break   (3 runs): same tone with gap/break inserted
...
//   continuity_break_01/02/03 are intentionally condition-identical within phase.
...
//
// Run:
//   node scripts/run_door_one_continuity_noise_replay_capstone.js
//
// Optional env overrides:
//   DOOR_ONE_CAPSTONE_AUDIO_DIR   — override ./test_signal/daw_tone_continuity_noise/
//   DOOR_ONE_CAPSTONE_OUTPUT_DIR  — override ./out_experiments/continuity_noise_replay_capstone
//   DOOR_ONE_CAPSTONE_PROVENANCE  — override ./out_provenance/continuity_noise_replay_capstone
...
const AUDIO_DIR = process.env.DOOR_ONE_CAPSTONE_AUDIO_DIR
    ?? path.resolve(__dirname, "../test_signal/daw_tone_continuity_noise");
const OUTPUT_DIR = process.env.DOOR_ONE_CAPSTONE_OUTPUT_DIR
    ?? "./out_experiments/continuity_noise_replay_capstone";
const PROV_ROOT = process.env.DOOR_ONE_CAPSTONE_PROVENANCE
    ?? "./out_provenance/continuity_noise_replay_capstone";
const PIN_ROOT = process.env.DOOR_ONE_CAPSTONE_PIN_ROOT
    ?? "./out_provenance/pinned_noise";
...
const BASE_POLICIES = {
    clock_policy_id: "clock.capstone.continuity_noise.v1",

    ingest_policy: {
        policy_id: "ingest.capstone.continuity_noise.v1",
    ...
    transform_policy: {
        policy_id: "transform.capstone.continuity_noise.v1",
        transform_type: "fft",
    ...
    compression_policy: {
        policy_id: "compress.capstone.continuity_noise.v1",
    ...
    anomaly_policy: {
        policy_id: "anomaly.capstone.continuity_noise.v1",
    ...
    merge_policy: {
        policy_id: "merge.capstone.continuity_noise.v1",
    ...
    post_merge_compression_policy: {
        policy_id: "merge.compress.capstone.continuity_noise.v1",
        selection_method: "topK",
        budget_K: 16,
        maxK: 16,
        include_dc: true,
    ...
    reconstruct_policy: {
        policy_id: "reconstruct.capstone.continuity_noise.v1",
    ...
    basin_policy: {
        policy_id: "basin.capstone.continuity_noise.v1",
    ...
    consensus_policy: {
        policy_id: "consensus.capstone.continuity_noise.v1",
...
const QUERY_SPEC = {
    query_id: "q.capstone.continuity_noise",
    kind: "energy_trend",
    mode: "ENERGY",
...
const QUERY_POLICY = {
    policy_id: "qp.capstone.continuity_noise.v1",
...
const EPOCH_CONTEXT = {
    epoch_id: "epoch.capstone.continuity_noise.v1",
    t_start: 0,
    t_end: 60,
    settlement_policy_id: "settlement.capstone.continuity_noise.v1",
    consensus_window: 10,
};
...
const SOURCE_ID = "door1.audio.daw_tone.continuity_noise_v1";
...
const RUN_PLAN = [
    ...
    { run_label: "continuity_break_01", phase: "phase_perturbation", filename: "continuity_break_01.wav" },
    { run_label: "continuity_break_02", phase: "phase_perturbation", filename: "continuity_break_02.wav" },
    { run_label: "continuity_break_03", phase: "phase_perturbation", filename: "continuity_break_03.wav" },
    // Phase C — return
...
async function main() {
    ...
    console.log("Door One Continuity Noise Replay Capstone");
    ...
    const lane = new DoorOneExecutiveLane({
        ...
        session_id: "door-one-continuity-noise-replay-capstone",
    });
    ...
    const manifest = {
        ...
        generated_from: "door_one_continuity_noise_replay_capstone runner — not canon, not promotion",
    };
...
function buildProvenanceReceipt({ cycleIndex, runLabel, phase, runDir, result, rawInput, filePath }) {
    ...
    return {
        ...
        generated_from:
            "Door One continuous noise replay capstone — durable provenance receipt, not canon, not promotion",
...
async function buildAndWritePinPacket({ provenanceRoot, pinRoot, digest, manifest }) {
    ...
    const packet = {
        ...
        packet_metadata: {
            declared_purpose: "continuous_noise_replay_capstone_cohort",
            pin_label: `daw_tone_continuity_noise_v1_cycles_${String(cycleMin ?? 0).padStart(4, "0")}_${String(cycleMax ?? 0).padStart(4, "0")}`,
