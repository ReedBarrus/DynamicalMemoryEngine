...
// Door Two canon consultation result — read-side only, not authority
// Imported from out_canon/ (generated output home for consultation records).
// If the file is absent the HUD strip shows a graceful "no result loaded" state.
import c1ConsultationResult from "../out_canon/c1_first_consultation_result.json";
    ...
    return (
        ...
        >
            ...
            <DoorOneStructuralMemoryHUD
                ...
                c1ConsultationResult={c1ConsultationResult}
            />
        </div>
    );
}