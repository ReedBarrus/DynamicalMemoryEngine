                    ...
                    {isFile ? (
                        <div>
                            <label style={{
                                ...
                                borderRadius: 6, border: `1px solid ${C.ruleLight}`,
                                ...
                                />
                                {pendingFile ? pendingFile.name : "choose .json / .csv / .wav"}
                            </label>
                            {detectedType && (
                                <div style={{ marginTop: 4, fontFamily: C.mono, fontSize: 10, color: C.textDim }}>
                            ...
                            {adapterStatus && (
                                <div style={{
                                    marginTop: 5, fontFamily: C.mono, fontSize: 10,
