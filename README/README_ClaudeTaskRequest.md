...
List only the files Claude is allowed to edit for this task.
...
List files or layers Claude must not change.
...
State the exact layer boundary Claude must preserve.
...
Specify exactly what Claude should run.
...
Fill this section before sending to Claude.
