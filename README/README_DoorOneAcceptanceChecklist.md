...
* [ ] replay / digest pipeline over provenance receipts for later reconstruction
...
* browser HUD repair / lawful baseline cleanup,
* explicit checklist confirmation for any remaining unchecked runtime evidence items,
* later replay / digest work over provenance receipts.
